...
for (( i=0 ; i < $(( ${#params[@]} / $nparams )) ; i++ )); do
    ...
    output_dir=fig_worldmap_prediction_error_diff_global_pentad-$days_per_pentad-multimonths/group-${GEPS6_group}
    output_error_dir=fig_worldmap_prediction_error_diff_Estd_global_pentad-$days_per_pentad-multimonths/group-${GEPS6_group}
