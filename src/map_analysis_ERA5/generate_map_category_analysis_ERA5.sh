...
catvar_postraw=postprocessed
catvar_varset=AR
catvar_varname=IVT
catvar_bnds="0 250 10000"
...
params=(
    postprocessed hf_surf_inst daily_mean mean_surface_sensible_heat_flux mean_surface_sensible_heat_flux
    postprocessed hf_surf_inst daily_mean mean_surface_latent_heat_flux mean_surface_latent_heat_flux
)
...
output_root="output_map_category_analysis_ERA5_pentad-${days_per_pentad}-leadpentad-${lead_pentads}"
for (( i=0 ; i < $(( ${#params[@]} / $nparams )) ; i++ )); do
    ...
    python3 generate_category_analysis_ERA5.py \
        --year-rng 1998 2017 \
        ...
        --varname $varname           \
        --catvar-postraw $catvar_postraw \
        --catvar-varset $catvar_varset \
        --catvar-varname $catvar_varname \
        --catvar-bnds $catvar_bnds \
