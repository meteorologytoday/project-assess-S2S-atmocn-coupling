...
sel_time2 = pd.Timestamp("2011-01-07")
...
for varname in varnames:
    ...
    data["ERA5"][varname] = ERA5_loader.readERA5(sel_time2, 24, varname)[varname_ERA5].isel(time=0).sel(longitude=sel_lon, latitude=sel_lat)
...
ax[1].set_title("%s: %s" % (S2S_dataset, sel_time2.strftime("%Y-%m-%d %H"), ))
