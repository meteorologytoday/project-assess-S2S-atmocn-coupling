...
category_file=$gendata_dir/MJO_category.csv
date_to_category_file=$gendata_dir/MJO_date_to_category.csv
...
params=(
    raw surf_inst daily_acc total_precipitation total_precipitation
...
#python3 src/make_strict_MJO_category.py --no-display

output_root="$gendata_dir/analysis/output_analysis_map_by_MJO_window-${days_per_window}-leadwindow-${lead_windows}"
